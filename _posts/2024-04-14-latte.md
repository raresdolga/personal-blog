...
## Language Generation
We train on lnaguage modelling datasets like WikiText-103 and OpenWebText for sequences of size 2048 and 1024 respectively. Results on the evaluation set are reported in table 2

| Model | Wiki103 (PPL) | OpenWebText (PPL)|
|-------|---|--- |
| Latte | 9.31 | 19.99 |
| GPT2  | 36.37 | 18.26 |
| Transformer-XL | - | 18.3 |
: Table2: Dev Scores for causal language generation. PPL - perplexity score, lower the scores the better

To grasp an understanding of how the model behaves, we show an example of language generation from a short promt.
